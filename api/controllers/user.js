...
exports.signUp = (req, res, next) => {
    User
        ...
        .then(hash => {
            const user = createUser(req.body.firstName, req.body.lastName, req.body.mobile, req.body.email, hash);
            return user.save();
        })
        .then(result => {
...
function createUser(firstName, lastName, mobile, email, hash) {
    return new User({
